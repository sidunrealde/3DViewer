...
export default function FileUpload() {
  ...
  return (
    <>
      ...
      <button
        onClick={openPicker}
        className="flex items-center gap-2 rounded-lg bg-cyan-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-cyan-500 active:bg-cyan-700"
